...
export function BcaPage() {
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-[#12316d] to-dark py-20 text-white md:py-28">
        ...
        <div className="relative mx-auto max-w-6xl px-4">
          ...
          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-200 md:text-xl">
            A technology-focused undergraduate program for students passionate about IT, software development, programming, AI, cybersecurity, and data analytics.
          </motion.p>
