...
facultyRouter.get("/", attachUserOptional, [query("limit").optional().isInt({ min: 1, max: 500 }).toInt()], async (req, res, next) => {
    try {
...
facultyRouter.post("/", verifyToken, async (req, res, next) => {
    try {
...
facultyRouter.put("/:id", verifyToken, async (req, res, next) => {
    try {
...
facultyRouter.delete("/:id", verifyToken, async (req, res, next) => {
    try {
