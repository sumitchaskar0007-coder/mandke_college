...
async function run() {
  ...
  await Admin.updateOne(
    { email: "admin@mandkecollege.in" },
    { name: "Super Admin", email: "admin@mandkecollege.in", passwordHash: hash, role: "superadmin" },
    { upsert: true }
  );
  ...
  await Blog.insertMany([
    {
      ...
      content:
        "<p>Commerce graduates who pair academics with communication and digital tools stand out in placements.</p>",
      category: "career",
      tags: ["career"],
  ...
  await Testimonial.insertMany([
    {
      ...
      quote:
        "The placement workshops and mentor conversations changed how I present myself in interviews. I felt prepared, not nervous.",
      rating: 5,
      isApproved: true,
